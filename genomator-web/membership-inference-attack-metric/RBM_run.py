...
# Ported from experiment/experiment_tools/tools/RBM_run.py unchanged except
...
# imported lazily (only inside providers.rbm_generate, after checking torch
# is installed) so providers.py stays importable without PyTorch. The model
# and training code (the RBM class, fit()) is untouched. Note main_RBM's
# fit() writes pickled genome strings, not VCF, at
# "{output_vcf_file}{epoch}.pickle" checkpoints - providers.rbm_generate
